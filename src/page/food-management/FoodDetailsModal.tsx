                ...
                <div className="p-6 overflow-y-auto space-y-6 flex-1 text-sm text-gray-600">
                    ...
                    <div className="grid grid-cols-3 gap-3 text-center">
                        ...
                        <div className="bg-gray-50 p-3 rounded-2xl border border-gray-100">
                            ...
                            <span className={`inline-block mt-1 px-2 py-0.5 rounded-full text-xs font-semibold uppercase ${
                                food.status === 'available' ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-600'
                            }`}>
                                {food.status}
                            </span>
                        </div>
