...
export default function FoodUpload() {
    ...
    const handleAddFood = async () => {
        ...
        try {
            ...
            // RESET FORM
            setForm({
                name: '', category: '', price: '', stock: '', image: null, type: '', description: '', galleryImages: [], collections: []
            });
            setOptions([]);
            setVariants([]);
        ...
        <div className="p-6 max-w-6xl mx-auto space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
                ...
                <div className="flex items-center gap-3">
                    <button 
                        onClick={() => {
                            setForm({ name: '', category: '', price: '', stock: '', image: null, type: '', description: '', galleryImages: [], collections: [] });
                        ...
                        <div className="mt-5">
                            ...
                            <div className="flex flex-col gap-2 max-h-48 overflow-y-auto p-3 border border-gray-200 rounded-xl bg-gray-50/50">
                                {collectionData && collectionData.length > 0 ? (
                                    ...
                                    <span className="text-sm text-gray-500 italic">No collections available</span>
                                )}
                            </div>
                            <p className="text-xs text-gray-400 mt-2">Select which collections this food belongs to (e.g., Best Sellers, Special Combos).</p>
                        </div>
                    </div>
